...
--
-- Table structure for table `flowline`
--

CREATE TABLE `flowline` (
  `id_flowline` int(11) NOT NULL,
  `ag` double NOT NULL,
  `ug` double NOT NULL,
  `date_of_work` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `work_order` (
  ...
  `other_works` varchar(100) DEFAULT NULL,
...
--
-- Indexes for table `flowline`
--
ALTER TABLE `flowline`
  ADD PRIMARY KEY (`id_flowline`);
...
ALTER TABLE `work_order`
  ...
  ADD UNIQUE KEY `uc_work_order` (`work_order_no`,`task_name`,`foreman`,`ag`,`ug`,`other_works`,`date_done`);
...
--
ALTER TABLE `equipment`
  MODIFY `id_equip` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1540;
--
...
--
-- AUTO_INCREMENT for table `flowline`
--
ALTER TABLE `flowline`
  MODIFY `id_flowline` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `manpower_list`
  MODIFY `id_staff` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
--
-- AUTO_INCREMENT for table `site_info`
--
ALTER TABLE `site_info`
  MODIFY `id_site` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;
--
-- AUTO_INCREMENT for table `weather`
--
ALTER TABLE `weather`
  MODIFY `id_weather` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
-- AUTO_INCREMENT for table `worker`
--
ALTER TABLE `worker`
  MODIFY `id_worker` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4524;
--
...
--
ALTER TABLE `workers_list`
  MODIFY `id_staff` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=242;
--
-- AUTO_INCREMENT for table `work_order`
--
ALTER TABLE `work_order`
  MODIFY `id_work_order` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=642;
--
-- AUTO_INCREMENT for table `wo_numbers`
--
ALTER TABLE `wo_numbers`
  MODIFY `id_wo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
