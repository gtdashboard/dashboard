...
<body id="page-top" class="index">
    ...
    <?php 
            ...
            $query="select * from worker where DATE(date) = '$dt' and category=1 and pno=$p";
            $result = $db_handle->runQuery($query);
            if(empty($result))
            {
                $query="select * from worker where DATE(date) = (select max(date) from worker where pno=$p) and category=1 and pno=$p";
                $result = $db_handle->runQuery($query);
            }
        ?>
    <!-- About Section -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h3 class="section-heading">Skilled1 Report</h3>
                    <div class="container">
                ...
                <table id="table1" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <td style=" visibility: hidden;"><input type="hidden" value="1" name="cat<?php echo $i;?>"/></td>
                        </tr>
                        <?php
                            }
                            $count_staff=$i;
