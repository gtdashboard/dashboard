        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Add New Report</h2>
                    <div class="container" style="margin-top:5%;text-align:center;">
                    <form action="next_daily_report.php" method="post">
                    <div class="form-group">
                    <label for="choose" style="font-weight:bolder;">Choose Report to Add / Update:</label>
                    <select name="cat" id="cat" class="form-control" onchange="test()">
                        <option value="1">Daily Report Page 1</option>
                        <option value="2">Daily Report page 2</option>
                    </select>
                    <label for="choose" style="font-weight:bolder;">Choose a date:</label>
                    <input type="text" class="form-control" placeholder="Choose Date" name="date_selected" id="date_selected" onchange="test()" autocomplete="off"/>    
                    <input type="hidden" name="date_val" id="date_val"/>
                    <button class="btn btn-primary login" style="width:100%;margin-top: 10px;">Enter</button>
                </div>
                </form>
                <br>
                <br>
