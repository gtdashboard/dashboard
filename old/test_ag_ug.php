...
<body>
    ...
    <div class="container" style="margin-top:5%;text-align:center;">
        <form action="view_wo.php" method="post">
            <div class="form-group">
                <label for="choose" style="font-weight:bolder;">Choose Report to View:</label>
                <input type="text" class="form-control" placeholder="Enter Work Order" name="wo" id="wo" onchange="test()"/> 
                <label for="choose" style="font-weight:bolder;">Choose a date:</label>
                <input type="text" class="form-control" placeholder="Choose Max Date" name="dt" id="date_selected" onchange="test()"/> 
