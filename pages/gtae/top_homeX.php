<?php
    ...
    $m=date('m');
    $y=date('Y');
    $query_wk="SELECT distinct(wo_numbers.work_order_no) as work_order_no,wo_status.id_wo as id_wo "
    ...
    $query_nk="SELECT distinct(wo_numbers.work_order_no) as work_order_no,wo_status.id_wo as id_wo "
            . "FROM wo_status,wo_numbers "
            . "WHERE STATUS =1 AND wo_status.id_wo NOT IN (SELECT id_wo FROM wo_status WHERE STATUS >1) and wo_numbers.pno=105 and wo_status.id_wo=wo_numbers.id_wo ";
