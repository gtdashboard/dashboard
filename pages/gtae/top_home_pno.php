 ...
 <?php require 'header_main.php';?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="row">
        <?php
            $query_basic="SELECT *,count(*) as no FROM general where pno=$pno";
        ...
        <div class="col-md-<?php echo 12/(2*$no);?> col-sm-6 col-xs-12">
    ...
    ?>
    <div class="col-md-<?php echo 12/($no);?>" style="text-align: center;">
    ...
    ?>
    <div class="col-md-<?php echo 12/($no);?> col-sm-12 col-xs-12">
        <div class="box box-primary">
        <div class="box-header with-border">
        <i class="fa fa-bar-chart-o"></i>
