    ...
    <body>
        ...
        <div class="container" style="width:100%;">
            ...
            <thead>
                    <tr>
                        <th></th>
                    <th style="text-align: center;width:20%">Work Order Number</th>
                    <th style="text-align: center;width:25%">Task Name</th>
                    <th style="text-align: center;width:15%">Responsible Foreman</th>
                    <th style="text-align: center;width:10%;">AG</th>
                    <th style="text-align: center;width:10%">UG</th>
                    <th style="text-align: center;width:25%;">Other Work</th>
                    </tr>
                    </thead>
                    <tbody>
                        <?php
                        $query2="select * from site_info where date_site = '$dt'";
                        ...
                        foreach($result as $row)
                        {
                            $i++;
                        ?>
                    <input type="hidden" name="id_wo<?php echo $i;?>" value="<?php echo $row['id_work_order'];?>"/>
                    <tr>
                        <td><a class="btn" onclick="del(this,'<?php echo $row['id_work_order'];?>')"><i class="fa fa-trash-o fa-lg"></i></a></td>
                ...
                <input type="hidden" name="id_site" value="<?php echo $row2['id_site'];?>"/>
                <div class="container" style="width:100%;border:2px solid black;padding:2%;">
                <fieldset>
